/*
+----------------------------------------------------------+
 @FileName: opcodes_dumper.cpp
 @Touch Date: Fri 26 Sep 2008 10:16:08 AM CST
 @Author: 惠新宸(laruence@yahoo.com.cn)
 @Description: an PHP opcodes dumper base on embed sapi
+----------------------------------------------------------+
*/
